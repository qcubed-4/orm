<?php
    ...
    class DatabaseCodeGen extends QCodegen
    {
        ...
        /**
         * Retrieves the title for the database associated with the current database index.
         *
         * @return string The formatted title string containing database index and database details,
         *                or an empty string if the database service is not initialized.
         */
        ...
        /**
         * Generates and returns the configuration XML string for the database settings and relationships.
         *
         * @return string The formatted XML string representing the database configuration.
         */
        ...
        /**
         * Generates and retrieves a report label for the number of available tables for code generation.
         *
         * @return string A descriptive label indicating the total count of tables available for code generation.
         */
...
//
//            // See on õige koht spetsiaalse täienduse võrdlemuse tegemiseks ja näiteks integer asemele int ja float asemel ???
...
//    }
        ...
        public function getCastString(SqlColumn $objColumn): string
        {
            return match ($objColumn->DbType) {
                ...
                Database\FieldType::FLOAT,
                Database\FieldType::INTEGER => ('$mixVal = (' . $this->getPhpCastType($objColumn->VariableType) . ')$mixVal;'),
        ...
        /**
         * Determines the PHP cast type based on the provided variable type.
         *
         * @param string $variableType The type of the variable to interpret and cast in PHP.
         *
         * @return string The equivalent PHP cast type as a string.
         */
        protected function getPhpCastType(string $variableType): string
        {
            return match (strtolower($variableType)) {
                Type::INTEGER, 'integer' => 'int',
                Type::FLOAT, 'double', 'real' => 'float',
