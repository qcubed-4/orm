...
/* This includes a library file is used by the codegen.cli and codegen.phpexe scripts
...
For more information, please visit https://qcubed.eu
');
	exit();
}
...
if ($strErrors = CodeGen::$RootErrors) {
	...
	printf("CodeGen settings (as evaluated from %s):\r\n%s\r\n\r\n", $settingsFile, CodeGen::GetSettingsXml());
}
