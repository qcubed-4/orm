<?php
	// NOTE for template developers: SQL and most other databases are either latin characters only, or Unicode for their
...
<?php } ?>
    ...
    * WARNING: If an object is found in a short-term cache, it will be used instead of the queried object and may
    * contain data fields that were fetched earlier. To really control what fields exist in this object, preceded
